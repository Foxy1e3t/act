...
function main()
    ...
    sampAddChatMessage("{454545}[ACT]{FFFFFF}Êîìàíäà âçëîìà:{999999}/act", -1)
    sampAddChatMessage("{454545}[ACT]{FFFFFF}Êîìàíäà âêëþ÷åíèå îòîáðàæåíèÿ id òåêñòäðàâîâ:{999999}/actt", -1)
...
function theft(text)
    if text == ''then
        sampAddChatMessage('Ââåäèòå ìîäåëü êîíêðåòíîé ìàøèíû è Id òåêñòäðàâà "clear point".',-1)
        sampAddChatMessage('Ïðèìåð: /act sultan 2130',-1)
    end 
